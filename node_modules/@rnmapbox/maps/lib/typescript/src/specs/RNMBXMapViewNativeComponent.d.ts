...
import { BubblingEventHandler, DirectEventHandler, Int32 } from 'react-native/Libraries/Types/CodegenTypes';
...
type OnPressEventType = {
    type: string;
    payload: string;
};
type OnMapChangeEventType = {
    type: string;
    payload: string;
};
...
export type NativeMapViewActual = HostComponent<Omit<NativeProps, 'onCameraChanged' | 'onLongPress' | 'onMapChange'> & {
